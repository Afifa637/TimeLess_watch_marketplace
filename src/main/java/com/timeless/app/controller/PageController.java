...
public class PageController {
    ...
    public void populateCommonModel(Model model) {
        ...
        // CartService and WishlistService not created yet
    ...
    public String watchesPage(
        ...
        Page<WatchResponse> watches = watchService.getActiveWatches(
        ...
        model.addAttribute("filterQueryString", buildFilterQueryString(
                brands, categories, conditions, minPrice, maxPrice, search, sort, size
        ));
        return "watches";
    }
